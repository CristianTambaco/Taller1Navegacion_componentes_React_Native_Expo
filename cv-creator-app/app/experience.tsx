  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.content}>
        ...
        <Text style={{ marginTop: 12, marginBottom: 4 }}>Fecha de Inicio *</Text>
        <TouchableOpacity
          style={styles.datePickerButton}
          onPress={() => setShowStartPicker(true)}
        >
          <Text style={styles.datePickerText}>
            {formData.startDate ? formData.startDate : "Selecciona la fecha"}
          </Text>
        </TouchableOpacity>
        {showStartPicker && (
          <DateTimePicker
        ...
        <Text style={{ marginTop: 12, marginBottom: 4 }}>Fecha de Fin</Text>
        <TouchableOpacity
          style={styles.datePickerButton}
          onPress={() => setShowEndPicker(true)}
        >
          <Text style={styles.datePickerText}>
            {formData.endDate ? formData.endDate : "Selecciona la fecha"}
          </Text>
        </TouchableOpacity>
        {showEndPicker && (
          <DateTimePicker
